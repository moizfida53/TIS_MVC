...
////                    $('#cmbSheet').focus();
////                    alert('Please Select Sheet'); // or your notify plugin
////                    return;
////                }
...
////                    //}
////                    // on success, if controller indicates success, show Bill Details modal with three categories and three buttons
////                    debugger;
...
////                sendEmail(payload, function (success) {
////                    if (success) {
...
////            $('#bdSendEmailGoto').on('click', function () {
////                //sendEmail(payload, function (success) {
////                //if (success) {
////                // redirect to Unassigned bills page
...
////        function sendEmail(billDetailsPayload, callback) {
////            $.ajax({
////                type: "POST",
////                url: "../../Import/SendEmail",
////                data: JSON.stringify({ BillDetails: billDetailsPayload }),
////                contentType: "application/json; charset=utf-8",
////                dataType: "json",
////                success: function (result) {
