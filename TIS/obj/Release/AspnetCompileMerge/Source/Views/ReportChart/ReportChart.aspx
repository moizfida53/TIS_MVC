...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
       ...
       function GetData() {
           $.ajax({
               type: "GET",
               url: "../../ReportChart/GetReportChart",
               success: function (result) {
                   var dtReportChart = result.dtReportChart;
                   FillGrid(dtReportChart);
                   chart(dtReportChart);
       ...
       function FillGrid(dtReportChart) {
       
       
            var deptsource =
            { localdata: dtReportChart,
                datafields:
                [
                ...
                datatype: "json"
                        ...
                        $("#jqxGrid").jqxGrid({
                            ...
                            theme: 'ui-redmond',
                            columns: [
                        //{ dataField: 'SUB_NO', text: 'Telephone Number' },
                        //{ dataField: 'BillDate', text: 'Bill Date', cellsformat: 'dd-MM-yyyy' },
                        { dataField: 'TRANS_TYPE', text: 'Transection Type' },
                        { dataField: 'Amount', text: 'Amount' }
                        //{ dataField: 'AUID', text: 'AUID' },
                        //{ dataField: 'CALLTYPE_TEXT', text: 'Call Type' },
                        //{ dataField: 'CCNAME', text: 'CCNAME' }
                        //{ dataField: 'BUNIT', text: 'BUNIT' },
                        //{ dataField: 'ORG', text: 'ORG' }
                        //{ dataField: 'PROVIDER', text: 'PROVIDER' },
                        //{ dataField: 'PROVIDER_TEXT', text: 'Provider Name' },
                        //{ dataField: 'COUNTRYID', text: 'COUNTRYID' }
                        ]
                        });
