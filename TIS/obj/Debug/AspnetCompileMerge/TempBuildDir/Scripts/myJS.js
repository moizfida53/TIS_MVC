...
$("#grdBillMaster").bind('rowselect', function (event) {
    var idx;
    debugger;
...
function IndexLoad() {
    ...
    //$("#btnProcess").jqxDropDownButton({ width: 150, height: 25, enableBrowserBoundsDetection: true });
    //$("#btnProcess").jqxDropDownButton('setContent', dropDownContentProcess);
    //$('#btnProcess').off('open');
    //$('#btnProcess').jqxDropDownButton({ disabled: true });
    //$('#btnProcess').on('open', function () { showWaive(); });
